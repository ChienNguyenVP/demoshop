      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="{{asset('template/dist/img/abc.jpg')}}" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{asset('template/dist/img/abc.jpg')}}" class="user-image" alt="User Image">
              <span class="hidden-xs">ChienDZ</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
      ...
      <ul class="sidebar-menu" data-widget="tree">
       ...
       {{--  <li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('admin/product')}}"><i class="fa fa-circle-o"></i> Danh sách</a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="{{asset('admin/kind')}}"><i class="fa fa-circle-o"></i> Loại sản phẩm</a></li>
            <li><a href="{{asset('admin/provider')}}"><i class="fa fa-circle-o"></i> Nhãn hiệu </a></li>
            <li><a href="{{asset('admin/color')}}"><i class="fa fa-circle-o"></i> Màu</a></li>
            <li><a href="{{asset('admin/size')}}"><i class="fa fa-circle-o"></i> Kích cỡ</a></li> 
        ...
        {{-- <li class="treeview">
          <a href="#">
            <i class="fa fa-tags" aria-hidden="true"></i></i> <span>Tags</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="{{asset('admin/tag')}}"><i class="fa fa-circle-o"></i> Danh sách</a></li>
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-paper-plane-o" aria-hidden="true"></i> <span>Shop</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="pages/tables/simple.html"><i class="fa fa-circle-o"></i> Ghé thăm</a></li>
