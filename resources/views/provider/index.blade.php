		...
		<div class="container">
		    ...
		    <div class="modal-content" >
		      <div class="modal-header">
		        ...
		        <h3 class="modal-title">Thêm Nhãn Hiệu</h3>
		      </div>
		        ...
		        <form action="" method="POST" role="form" enctype="multipart/form-data" >
		        	 @csrf
			        	<div class="form-group">
			        		...
			        		<input type="text" name="provider" id="provider" class="form-control" id="title" placeholder="">    
			       	</div>
		        </form>
		      </div>
	...
	$('#table').on('click','.btn-danger' ,function(){
        ...
        .then((willDelete) => {
          if (willDelete) {
            ...
            $.ajax({
              url: '{{asset('')}}admin/provider/delete/'+ id,
              type: 'delete',
              success: function (response) {
