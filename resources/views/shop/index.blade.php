...
<!--//tags -->
<link href="{{asset('shop_asset/css/bootstrap.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{asset('shop_asset/css/style.css')}}" rel="stylesheet" type="text/css" media="all" />
<link href="{{asset('shop_asset/css/font-awesome.css')}}" rel="stylesheet"> 
<link href="{{asset('shop_asset/css/easy-responsive-tabs.css')}}" rel='stylesheet' type='text/css'/>
...
<div class="header" id="home">
	<div class="container">
		<ul>
		    <li> <a href="{{asset('admin.login')}}"><i class="fa fa-unlock-alt" aria-hidden="true"></i> Sign In </a></li>
			...
			<div class="modal-dialog">
				...
				<div class="modal-content">
					<div class="modal-header">
						...
						<div class="col-md-4 modal_body_right modal_body_right1">
							<img src="{{ asset('shop_asset/images/log_pic.jpg') }}" alt=" "/>
						</div>
						<div class="clearfix"></div>
					</div>
				</div>
...
<!-- banner -->
            ...
            <div class="banner_bottom_agile_info_inner_w3ls">
    	           <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="{{ asset('shop_asset/images/bottom1.jpg') }}" alt=" " class="img-responsive" />
							<figcaption>
					 ...
					 <div class="col-md-6 wthree_banner_bottom_grid_three_left1 grid">
						<figure class="effect-roxy">
							<img src="{{ asset('shop_asset/images/bottom2.jpg') }}" alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>F</span>all Ahead</h3>
								<p>New Arrivals</p>
							</figcaption>			
	...
	<div class="schedule-bottom">
		<div class="col-md-6 agileinfo_schedule_bottom_left">
			<img src="{{ asset('shop_asset/images/mid.jpg') }}" alt=" " class="img-responsive" />
		</div>
		...
		<div class="container">
		    <h3 class="wthree_text_info">New <span>Arrivals</span></h3>		
				<div id="horizontalTab">
					...
					<!--/tab_one-->
						<div class="tab1">
							@foreach($products as $pro)<div class="col-md-3 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="{{asset(\Storage::url($pro->anh()->link))}}" alt="" class="pro-image-front">
										<img src="{{asset(\Storage::url($pro->anh()->link))}}" alt="" class="pro-image-back">
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="{{asset($pro->slug)}}" class="link-product-add-cart">Quick View</a>
												</div>
											</div>
									...
									<div class="item-info-product ">
										<h4><a href="{{asset($pro->slug)}}">{{$pro->name}}</a></h4>
										<div class="info-product-price">
											<span class="item_price">{{$pro->sale_prime}}VND</span>
											{{-- <del>$69.71</del> --}}
										</div>
		...
		<div class="col-md-5 bb-grids bb-left-agileits-w3layouts">
			<a href="womens.html">
			   <div class="bb-left-agileits-w3layouts-inner grid">
					<figure class="effect-roxy">
							<img src="{{ asset('shop_asset/images/bb1.jpg') }}" alt=" " class="img-responsive" />
							<figcaption>
		...
		<div class="col-md-7 bb-grids bb-middle-agileits-w3layouts">
		      <a href="mens.html">
		       <div class="bb-middle-agileits-w3layouts grid">
			           <figure class="effect-roxy">
							<img src="{{ asset('shop_asset/images/bottom3.jpg') }}" alt=" " class="img-responsive" />
							<figcaption>
								<h3><span>S</span>ale </h3>
								<p>Upto 55%</p>
							</figcaption>			
		      ...
		      <div class="bb-middle-agileits-w3layouts forth grid">
						<figure class="effect-roxy">
							<img src="{{ asset('shop_asset/images/bottom4.jpg') }}" alt=" " class="img-responsive">
							<figcaption>
								<h3><span>S</span>ale </h3>
								<p>Upto 65%</p>
							</figcaption>		
...
<!--/grids-->
      <div class="agile_last_double_sectionw3ls">
            <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="womens.html"><img src="{{ asset('shop_asset/images/bot_1.jpg') }}" alt=" "><h4>Flat <span>50%</span> offer</h4></a>
					
			</div>
			 <div class="col-md-6 multi-gd-img multi-gd-text ">
					<a href="womens.html"><img src="{{ asset('shop_asset/images/bot_2.jpg') }}" alt=" "><h4>Flat <span>50%</span> offer</h4></a>
			</div>
			<div class="clearfix"></div>
	   </div>							
<!--/grids-->
		...
		<div class="col-md-9 footer-right">
			<div class="sign-grds">
				...
				<div class="col-md-3 sign-gd flickr-post">
					...
					<ul>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t1.jpg') }}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t2.jpg') }}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t3.jpg') }}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t4.jpg') }}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t2.jpg') }}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t1.jpg') }}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t3.jpg') }}" alt=" " class="img-responsive" /></a></li>
						<li><a href="single.html"><img src="{{ asset('shop_asset/images/t4.jpg') }}" alt=" " class="img-responsive" /></a></li>
...
<!-- js -->
<script type="text/javascript" src="{{asset('shop_asset/js/jquery-2.1.4.min.js')}}"></script>
<!-- //js -->
<script src="{{asset('shop_asset/js/modernizr.custom.js')}}"></script>
	<!-- Custom-JavaScript-File-Links --> 
	<!-- cart-js -->
	<script src="{{asset('shop_asset/js/minicart.min.js')}}"></script>
<script>
	// Mini Cart
...
<script src="{{asset('shop_asset/js/easy-responsive-tabs.js')}}"></script>
<script>
...
<!-- //script for responsive tabs -->		
<!-- stats -->
	<script src="{{asset('shop_asset/js/jquery.waypoints.min.js')}}"></script>
	<script src="{{asset('shop_asset/js/jquery.countup.js')}}"></script>
	<script>
		$('.counter').countUp();
	</script>
<!-- //stats -->
<!-- start-smoth-scrolling -->
<script type="text/javascript" src="{{asset('shop_asset/js/move-top.js')}}"></script>
<script type="text/javascript" src="{{asset('shop_asset/js/jquery.easing.min.js')}}"></script>
...
<!-- for bootstrap working -->
<script type="text/javascript" src="{{asset('shop_asset/js/bootstrap.js')}}"></script>
</body>
</html>
