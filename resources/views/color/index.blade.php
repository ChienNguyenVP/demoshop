		        ...
		        <form action="" method="POST" role="form" enctype="multipart/form-data" >
		        	 @csrf
			        	<div class="form-group">
			        		<label for="">Màu</label>
			        		<input type="text" name="color" id="color" class="form-control" id="title" placeholder="">    
			       		</div>
			       		<div class="form-group">
			        		<label for="">Chọn</label>
			        		<input type="color" name="code" id="code" class="form-control" id="title" placeholder="" style="width: 60px; text-align: center;">    
			       		</div>
		        </form>
		      </div>
